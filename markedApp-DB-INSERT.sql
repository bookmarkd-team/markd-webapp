...
--
-- Host: localhost:8889
-- Generation Time: Dec 18, 2020 at 06:08 PM
...
(1, 'admin', 'admin', 'admin@admin.com', '1234567', '2020-12-03 22:26:55'),
...
--
ALTER TABLE `save`
  MODIFY `saveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `boards`
  ADD CONSTRAINT `boards_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);

--
-- Constraints for table `questionansweruser`
--
ALTER TABLE `questionansweruser`
  ADD CONSTRAINT `questionansweruser_ibfk_1` FOREIGN KEY (`questionId`) REFERENCES `quizquestion` (`questionId`),
  ADD CONSTRAINT `questionansweruser_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);
...
--
ALTER TABLE `save`
  ADD CONSTRAINT `save_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  ADD CONSTRAINT `save_ibfk_2` FOREIGN KEY (`destinationId`) REFERENCES `destination` (`destinationId`);

--
-- Constraints for table `savedtoboard`
--
ALTER TABLE `savedtoboard`
  ADD CONSTRAINT `savedtoboard_ibfk_1` FOREIGN KEY (`boardId`) REFERENCES `boards` (`boardId`),
  ADD CONSTRAINT `savedtoboard_ibfk_2` FOREIGN KEY (`destinationId`) REFERENCES `destination` (`destinationId`);